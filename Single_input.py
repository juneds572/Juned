...
class Module3:
	...
	def chandassu(self,akshara_list,lg_list,lm):
		self.kandapadya(copy.deepcopy(akshara_para),copy.deepcopy(lg_para),copy.deepcopy(lg_dup))
		self.shatpadi(copy.deepcopy(akshara_para),copy.deepcopy(lg_para),copy.deepcopy(lg_dup))
		self.ragale(copy.deepcopy(akshara_para),copy.deepcopy(lg_para),copy.deepcopy(lg_dup))
		self.vrutta(copy.deepcopy(akshara_para),copy.deepcopy(lg_para),copy.deepcopy(lg_dup))
		print("Invalid Poem")
